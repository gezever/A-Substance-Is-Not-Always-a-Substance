...
/opt/apache-jena-5.6.0/bin/sparql --results=TURTLE --data=/tmp/merge.ttl --query bash/chemont_to_xkos.rq > /tmp/merge3.ttl
...
/opt/apache-jena-5.6.0/bin/riot --formatted=TURTLE data/processed/rdf/classyfire.ttl /tmp/merge5.ttl > /tmp/merge6.ttl
cp /tmp/merge5.ttl data/processed/rdf/substances_taxonomy.ttl
cp /tmp/merge6.ttl data/processed/rdf/substances_taxonomy_levels.ttl
