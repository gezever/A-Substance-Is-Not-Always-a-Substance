...
Each substance name and ChemOnt class label was encoded using the \path{all-MiniLM-L6-v2} sentence-transformer model~\cite{Reimers2019,Wang2020MiniLM,devlin-etal-2019-bert}, yielding a 384-dimensional dense vector representation.
...
transformer models (\path{all-MiniLM-L6-v2}, \path{all-mpnet-base-v2},
\path{allenai/scibert_scivocab_uncased}, and \path{dmis-lab/biobert-v1.1}) within the \emph{sentence-transformers}
