...
transformer models (\texttt{all-MiniLM-L6-v2, all-mpnet-base-v2, allenai/scibert\_scivocab\_uncased} 
and \texttt{dmis-lab/biobert-v1.1}) within the \texttt{sentence-transformers}
framework~\cite{Reimers2019,Wang2020MiniLM,devlin-etal-2019-bert}. Cosine
similarity was used to rank all ChemOnt classes for each substance name.
